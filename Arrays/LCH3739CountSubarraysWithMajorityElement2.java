/*  
Change the array like : if element is target then to +1 else to -1
Then subarray having sum  > 0 will be the ones with majority element that is if +1 is more than half of that subarray then sum > 0
So now solve like count subarray having sum > k where (k == 0)
*/
